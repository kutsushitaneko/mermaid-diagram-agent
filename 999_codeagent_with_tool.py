...
agent = CodeAgent(tools=[], model=model, additional_authorized_imports=['requests', 'bs4'], code_block_tags=custom_code_block_tags)
#agent.run("Could you get me the title of the page at url 'https://huggingface.co/blog'?")
#agent.run("東京ディズニーランドの天気予報は次のURLから取得できます。明日の東京ディズニーランドはレジャー日和ですか？ また、その理由は？日没は何時？日本語で答えてね。'https://api.open-meteo.com/v1/forecast?latitude=35.6331&longitude=139.8806&daily=weather_code,temperature_2m_max,temperature_2m_min,sunrise,sunset&hourly=temperature_2m,relative_humidity_2m,weather_code&timezone=Asia%2FTokyo&forecast_days=2'")
#agent.run("今日の日付は？")
